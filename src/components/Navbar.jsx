    ...
    <>
          ...
          <div className="flex justify-between items-center text-sm">
            <div className="flex items-center gap-6">
              <a
                ...
                className="flex items-center gap-2 hover:text-blue-100 transition-colors duration-200"
              >
      ...
      <div className="lg:hidden bg-gradient-to-r from-blue-600 to-blue-700 text-white py-2 px-4 fixed top-0 left-0 right-0 z-50">
        <div className="flex justify-between items-center text-xs">
          <a
            href="tel:+917067534498"
            className="flex items-center gap-1.5 font-medium hover:text-blue-100 transition-colors"
          >
